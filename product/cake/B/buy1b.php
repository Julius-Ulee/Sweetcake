...
<div class="row g-2 row-cols-lg-4 row-cols-2 row-cols-md-3" style="margin-top:5%;">
  ...
  <div class="container">
    <div class="card1">
      ...
      <input type="text" name="angka1" class="bil" autocomplete="off" placeholder="Masukkan Jumlah Kue">
      <input type="text" value="Rp.200000" style="color: white;" class="bil" disabled="disable">
      <select class="opt" name="operasi">
        <option value="kali">Hitung</option>
      </select>
      <input onclick="myFunction()" type="submit" name="hitung" value="Proses" class="tombol">                     
    </form>
      <?php if(isset($_POST['hitung'])){
      $kode = bin2hex(random_bytes(10));
        }
      ?>
      <input type="text" value="Rp.0" style="color: white;" class="bil" placeholder="Rp.190.000" disabled="disable">
      <div style="text-align: center; color: white;">
      <h4>Kode Pembayaran Anda</h4><br>
      <h5>Silahkan Screenshoot Kode Pembayaran</h5>
      <input type="text" value="Kode: -" style="color: white;" class="bil" disabled="disable"><br>
<p id="time"></p>
    </div>
  </div>
